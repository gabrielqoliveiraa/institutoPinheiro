    ...
    return (
        <Flex width='100%' as='header' maxWidth={1480} h='20' mx='auto' mt='4' px='6' align='center'>
            ...
            <Flex align='center' ml='auto'>
                <HStack spacing='8' pr='8' py='1' color='gray.300' borderRightWidth={1} borderColor='gray.700' mx='8'>
                ...
                <Flex align='center'>
                    <Box mr='4' textAlign='right'>
                        ...
                        <Text color='gray.300' fontSize='small'>email@email.com.br</Text>
                    </Box>

                    <Avatar size='md' name='Gabriel Queiroz' src='https://github.com/gabrielqoliveiraa.png'/>
                </Flex>
            </Flex>
        </Flex>
    )
